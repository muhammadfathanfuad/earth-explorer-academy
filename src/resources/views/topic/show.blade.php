...
<div class="row justify-content-center">
    <div class="col-md-10">
                ...
                <div class="col-md-8">
                    <div class="bubble-chat p-4 text-white">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <button onclick="prevSlide()" id="btn-prev" class="btn btn-outline-secondary rounded-pill px-4" style="display: none;">Mundur</button>
                            
                            <button onclick="nextSlide()" id="btn-next" class="btn btn-sci-fi rounded-pill px-4 ms-auto">
                                Lanjut <span class="ms-2">▶</span>
                            </button>

                            <button onclick="enterQuizMode()" id="btn-quiz" class="btn btn-warning fw-bold rounded-pill px-5 ms-auto animate__animated animate__pulse animate__infinite" style="display: none;">
                                SIAP UJI NYALI? 🚀
                            </button>
                        </div>
        ...
        <div id="quiz-mode" class="card card-custom border-info mb-5 animate__animated animate__zoomIn" style="display: none;">
            ...
            <div class="card-body p-5 text-center">
                <div id="question-screen">
                    ...
                    <div class="row g-3 justify-content-center">
                        <div class="col-md-6"><button onclick="checkAnswer('a')" id="btn-a" class="btn btn-outline-light w-100 p-4 fs-5 text-start answer-btn h-100"></button></div>
                        <div class="col-md-6"><button onclick="checkAnswer('b')" id="btn-b" class="btn btn-outline-light w-100 p-4 fs-5 text-start answer-btn h-100"></button></div>
                        <div class="col-md-6"><button onclick="checkAnswer('c')" id="btn-c" class="btn btn-outline-light w-100 p-4 fs-5 text-start answer-btn h-100"></button></div>
                        <div class="col-md-6"><button onclick="checkAnswer('d')" id="btn-d" class="btn btn-outline-light w-100 p-4 fs-5 text-start answer-btn h-100"></button></div>
                    </div>
                </div>
...
<script>
    ...
    function saveScoreToDatabase(finalScore) {
        fetch("{{ route('score.store') }}", {
            ...
            body: JSON.stringify({ topic_id: {{ $topic->id }}, score: finalScore })
        });
    }
</script>
